...
{
    public class AreaProgramModel:Model
    {
        ...
        private ObservableCollection<ProgramModel> _programCollection;
        public ObservableCollection<ProgramModel> ProgramCollection
        {
            get
            {
